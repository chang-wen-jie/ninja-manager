    ...
    public class NinjaManagerDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EquipmentModel>().HasData(
                ...
                new EquipmentModel { EquipmentId = 2, Name = "Jacket", Category = EquipmentCategory.Chest, GoldValue = 20, Strength = 2, Intelligence = 1, Agility = 0 },
                new EquipmentModel { EquipmentId = 3, Name = "Shuriken", Category = EquipmentCategory.Hands, GoldValue = 5, Strength = 0, Intelligence = 0, Agility = 1 },
                new EquipmentModel { EquipmentId = 4, Name = "Kunai", Category = EquipmentCategory.Hands, GoldValue = 8, Strength = 0, Intelligence = 1, Agility = 0 },
                ...
                new EquipmentModel { EquipmentId = 6, Name = "Ninja Sandals", Category = EquipmentCategory.Feet, GoldValue = 12, Strength = 0, Intelligence = 0, Agility = 3 },
                new EquipmentModel { EquipmentId = 7, Name = "Necklace of Wisdom", Category = EquipmentCategory.Necklace, GoldValue = 25, Strength = 0, Intelligence = 3, Agility = 0 },
                new EquipmentModel { EquipmentId = 8, Name = "Ring of Strength", Category = EquipmentCategory.Ring, GoldValue = 30, Strength = 4, Intelligence = 0, Agility = 0 },
                new EquipmentModel { EquipmentId = 9, Name = "Scroll of Healing", Category = EquipmentCategory.Hands, GoldValue = 50, Strength = 0, Intelligence = 5, Agility = 0 },
                new EquipmentModel { EquipmentId = 10, Name = "Blade of Destiny", Category = EquipmentCategory.Hands, GoldValue = 100, Strength = 10, Intelligence = 0, Agility = 0 }
            );
